...
You can find doc [[https://github.com/syl20bnr/spacemacs/tree/master/contrib/fasd][here]]

#+BEGIN_SRC emacs-lisp
  (add-to-list 'dotspacemacs-configuration-layers 'fasd)
#+END_SRC
...
You can find doc [[https://github.com/syl20bnr/spacemacs/tree/master/contrib/lang/lua][here]]

#+BEGIN_SRC emacs-lisp
  (add-to-list 'dotspacemacs-configuration-layers 'lua)
#+END_SRC
