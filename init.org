...
#+BEGIN_SRC emacs-lisp :noweb yes
  (add-hook 'company-mode-hook '(lambda()
            <<define-keys(fn="define-key", state="", map="company-active-map", keys=company-active-keys)>> ))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :noweb yes :results silent
  (add-hook 'helm-mode-hook '(lambda()
            <<define-keys(fn="define-key", state="",map="helm-map", keys=helm-keys)>> ))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :noweb yes :results silent
  (add-hook 'org-mode-hook '(lambda()
            <<define-keys(fn="define-key", state="", map="org-mode-map", keys=org-mode-keys)>> ))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :noweb yes :results silent
  (add-hook 'c-mode-hook '(lambda()
            <<define-keys(fn="define-key", state="", map="c-mode-map", keys=c-c++-mode-keys)>> ))
  (add-hook 'c++-mode-hook '(lambda()
            <<define-keys(fn="define-key", state="", map="c++-mode-map", keys=c-c++-mode-keys)>> ))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :noweb yes :results silent
  <<define-keys(fn="evil-ex-define-cmd", state="", map="", keys=global-evil-ex)>>
#+END_SRC
...
In the end of configuration, I'll load some private config from
=~/.personal.el=, which contains something like password or account settings.

#+BEGIN_SRC emacs-lisp
  (let ((config "~/.personal.el"))
    (when (file-exists-p config) (load-file config)))
#+END_SRC