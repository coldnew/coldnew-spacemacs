...
** Use org-mode to write literature Clojure code

TODO: need to use 8.3 org-mode
...
#+BEGIN_SRC emacs-lisp
  (req-package cider
    ...
    (progn
      ...
      ;; always use `dev' profile with `cider-jack-in'
...
#+BEGIN_SRC emacs-lisp
  (req-package erc-log
    ...
    (progn
      (erc-log-mode 1)
      ;; setup log file path
      (setq erc-log-channels-directory (concat user-cache-directory "erc"))
      (unless (file-exists-p erc-log-channels-directory)
        (mkdir erc-log-channels-directory t))
      ;; all log save as utf-8
      (setq erc-log-file-coding-system 'utf-8)
      ;; when send/recv message save it to log
